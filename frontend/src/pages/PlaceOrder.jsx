...
function PlaceOrder() {
  ...
  //Address Detail accepeted via form
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      switch (method) {
        ...
        //API Call for for COD
        case "cod":
          const response = await axios.post(backendUrl + "/api/v1/order/cod", orderData, { headers: { token } });
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col sm:flex-row justtify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t">
